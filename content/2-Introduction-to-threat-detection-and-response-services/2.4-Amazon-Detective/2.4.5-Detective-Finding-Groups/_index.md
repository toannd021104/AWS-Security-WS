...
Detective finding groups help you analyze multiple related activities for a potential security event. Instead of investigating each finding separately, you can look at the whole group to understand the incident better. Detective uses graph analysis to link findings and entities, making investigations faster and more complete.
